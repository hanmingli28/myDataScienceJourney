# -*- coding: utf-8 -*-
"""
Created on Sat Nov 13 17:32:59 2021
...
## https://newsapi.org/v2/everything?apiKey=8f4 (Links to an external site.) DO NOT USE MY KEY :) e22100f22b&q=bitcoin

 

topics=["wildfire", "global warming", "drought","climate change"]
...
# figure, axes = plt.subplots(nrows=2, ncols=2) #don't run this line
...
##
Final_News_DF_Labeled.to_csv("Labeled_News_Data_from_API_111321.csv")
...
print("Accuracy:",metrics.accuracy_score(TestLabels, DT_pred))
df_cm = pd.DataFrame(bn_matrix, range(4), range(4))
...
tree.export_graphviz(estimator, out_file='tree.dot',
                ...
                ## which are the feature names.
                  ...
                  proportion = False,
                  special_characters=True)      
os.system('dot -Tpng tree.dot -o random_forest.png')
